...
@app.route("/")
def home():
    return render_template("home11111.html")                    ## HOME.HTML IS THE TEMPLATE NAME // it can be anything home11.html


@app.route("/classify11111", methods=["POST", "GET"])  
def upload_file():
    ...
    return render_template(
        "classify11111.html", image_file_name=file.filename, label=label, prob=prob) 
